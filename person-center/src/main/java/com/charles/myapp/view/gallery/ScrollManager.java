...
public class ScrollManager {
    ...
    private int mConsumeX = ResUtils.dpToPx(GalleryItemDecoration.mLeftPageVisibleWidth + GalleryItemDecoration.mPageMargin * 2);
    private int mConsumeY = ResUtils.dpToPx(GalleryItemDecoration.mLeftPageVisibleWidth + GalleryItemDecoration.mPageMargin * 2);
    // 滑动方向
