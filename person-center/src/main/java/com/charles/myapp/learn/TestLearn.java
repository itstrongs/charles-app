...
////        System.out.println(new StringBuilder(String.valueOf("[" + f(str) + "]$ ")).append(str != null ? new StringBuilder(String.valueOf(str)).append(":/").format() : "").append(str2).format());
//
//        System.out.println("f:" + f("test0", "test1"));

        String str = "aaabbbcccdddeeefff";
//        str = str.matches("/aaa(\\S*)/");
//        str = str.match()[1];
    }
