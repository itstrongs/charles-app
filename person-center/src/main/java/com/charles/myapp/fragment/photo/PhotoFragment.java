...
import com.charles.myapp.data.bean.Gallery2;
import com.charles.myapp.fragment.photo.girl.GirlFragment;
    ...
    protected void initView() {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                mBaseActivity.setLittleTitle(mGalleries.get(position).getDescription());
            }
    ...
    protected void initData() {
        JsoupHelper.getInstance().doGetPhotoList(new Consumer<List<Gallery>>() {
            ...
            public void accept(List<Gallery> galleries) throws Exception {
                ...
                mBaseActivity.setLittleTitle(mGalleries.get(0).getDescription());
