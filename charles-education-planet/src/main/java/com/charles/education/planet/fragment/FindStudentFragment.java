 ...
 */
public class FindStudentFragment extends BaseFragment {
    ...
    protected int setFragmentLayout() {
        return R.layout.fragment_find_student;
    }
    ...
    private class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new MyAdapter.MyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_find_student, parent, false));
        }
